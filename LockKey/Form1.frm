...
Begin VB.Form Form1 
   ...
   Caption         =   "Hot Key Lock - PC-DOS Workshop"
   ClientHeight    =   2685
   ClientLeft      =   150
   ClientTop       =   435
   ClientWidth     =   6495
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "這個工具可以幫助您禁用Windows徽標鍵,Ctrl鍵,Alt鍵,Shift鍵,Fx功能鍵等系統功能鍵,也可以實現對鍵盤的封鎖"
      Height          =   405
      Index           =   0
      Left            =   720
      TabIndex        =   0
...
End If
HooK
If GetSetting("PC-DOS Workshop", "KeyLock", "EnableKeyLockAppDebugMode") = "1" Then
Me.Visible = True
Else
Me.Visible = False
End If
